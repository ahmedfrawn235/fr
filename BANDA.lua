...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀  𝙀𝗟 𝗦𝙀𝗔𝗗◍━━━━⩺ ⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀  𝙀𝗟 𝗦𝙀𝗔𝗗◍━━━━⩺"
echo "TG IS NOT FIND IN FILES BOT"
echo "⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀 𝗔𝗟𝗠𝙊𝗟𝙐??◍━━━━⩺ ⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀  𝙀𝗟 𝗦𝙀𝗔𝗗◍━━━━⩺"
exit 1
fi
if [ ! $token ]; then
echo "⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀  𝙀𝗟 𝗦𝙀𝗔𝗗◍━━━━⩺ ⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀  𝙀𝗟 𝗦𝙀𝗔𝗗◍━━━━⩺"
...
var = true 
elseif tonumber(user_id) == tonumber(1679303777) then
var = true  
...
if text == "توكن زب مبرمج" and SudoBot(msg) or text == 'جلب زب مبرمج' and SudoBot(msg) then 
if not Debn(msg) then
...
if text == 'المبرمج فرعون ' and Debn(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗗𝙀𝗩 𝙀𝗟 𝗦𝙀𝗔𝗗',url="t.me/UU_ML1"},{text = '𝗗𝙀𝗩 𝗙𝙍𝗔𝙒𝗡',url="DEV_FRAWN"}},
{{text = '𝗦𝙊𝙐𝙍𝗖𝙀  𝙀𝗟 𝗦𝙀𝗔𝗗', url="t.me/source_frawn"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/source_frawn/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
"‏ من ب التعاسه إطالة الندم ع شيء إنتهى. ◍ ",
...
if text == 'العاب فرعون' or text == 'العاب' or text == 'الالعاب' then  
local Text = [[  
...
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مطور الاساسي  عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(SUDO) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مطور الثانوي عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(SUDO) then  
...
if result.id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر ال  \n")
return false 
end
if result.id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مطور الثانوي \n")
return false 
end
if result.id_ == tonumber(SUDO) then
...
if tonumber(result.sender_user_id_) == tonumber(SUDO) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع كتم مطور الاساسي  عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(SUDO) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مطور الثانوي عام")
...
if result.id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " ◍ لا يمكنك كتم مطور الاساسي  \n")
return false 
end
if result.id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مطور الثانوي \n")
...
st = https.request('https://api.telegram.org/bot'..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀  𝙀𝗟 𝗦𝙀𝗔𝗗◍━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀  𝙀𝗟 𝗦𝙀𝗔𝗗◍━━━━⩺ٴ\n ◍ ◍ ')
end
...
{
{text = '𝗦𝙊𝙐𝙍𝗖𝙀 𝗔𝗟𝗠𝙊??𝙐𝗞', url="t.me/source_frawn"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '𝗦??𝙐𝙍𝗖𝙀 𝗔𝗟𝗠𝙊𝗟𝙐𝗞', url="t.me/source_frawn"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
"صراحه  |  يدل على أن الكذب  تكون ضرورية شي؟",
